...
CREATE TABLE `tbos` (
  ...
  CONSTRAINT `tbos_ibfk_1` FOREIGN KEY (`idclientes`) REFERENCES `tbclientes` (`idclientes`)
...
INSERT INTO `tbos` VALUES (1,'2023-02-25 01:39:07','Notebook','não liga','Troca de Fonte','Zé',87.50,1);
...
-- Dump completed on 2023-02-26  7:52:28
